...
-----------------------------------------------
1.好处:
  我们调用服务返回的类型有 String,List,Map,Bean,Int,Boolean 等类型,
可以统一成 result 对象返回，方便项目组其他成员调用接口。
...
public enum HttpStatus {
     ...
     */
    NO_CONTENT(204, "No Content", "请求内容为空"),
    /**
     ...
     */
    BAD_REQUEST(400, "Bad Request", "错误请求！外部接口调用异常！"),
    /**
     * {@code 401 Unauthorized}.
     * @see <a href="http://tools.ietf.org/html/rfc2616#section-10.4.2">HTTP/1.1</a>
     */
    UNAUTHORIZED(401, "Unauthorized", "未经授权的"),
    /**
     ...
     */
    NOT_FOUND(404, "Not Found", "请求地址未找到"),
    /**
     ...
     */
    CONFLICT(409, "Conflict", "数据记录已存在，不能重复添加"),
    /**
     * {@code 410 Gone}.
     ...
     */
    PRECONDITION_FAILED(412, "Precondition Failed", "传递参数错误"),
    /**
    ...
    private final String cnreasonPhrase;

    private HttpStatus(int value, String reasonPhrase, String cnreasonPhrase) {
        this.value = value;
        this.reasonPhrase = reasonPhrase;
        this.cnreasonPhrase = cnreasonPhrase;
    }
    ...
    public String getCnreasonPhrase() {
        return cnreasonPhrase;
    }
